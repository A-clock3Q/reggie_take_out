...
public class GeneratorApp {
    ...
    private static final String JDBC_URL = "jdbc:mysql://192.168.23.160:3306/reggie?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSOWRD = "123456";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.zgj";
    private static final String MODULE_NAME = "reggie";

    // 表名，多个表使用英文逗号分割
    private static final String TBL_NAMES = "employee";
